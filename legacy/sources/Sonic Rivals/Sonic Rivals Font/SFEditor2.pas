...
Function IntToCr(const V: DWord; Pos: Boolean): DWord;
var Sum: DWord; n, Step: Integer;
begin
  Step:=$800000;
  //If (FontID>0) and Pos then Result:=$3C800000 else Result:=$3B000000;
  ...
  begin
    If Pos then Result:=$3C800000 else Result:=$3B000000;
  end;
...
Function CrToInt(const V: DWord; Pos: Boolean): DWord;
var Sum: DWord; n, Step: Integer;
begin
  //Pos:=False;
  Result:=0;
  ...
  begin
    If Pos then n:=$3C800000 else n:=$3B000000;
  end;
  //If (FontID>1) and Pos then n:=$3C800000 else n:=$3B000000;
  Sum:=0;
  While n<V do
  begin
    Inc(Result);
