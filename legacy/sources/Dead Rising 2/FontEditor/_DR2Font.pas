...
Type
  ...
  public
    ...
    function SaveForXBOX360(const Stream: TStream; const Width, Height: Integer; Mirror, ForceAlt: Boolean): Boolean; overload;
    function SaveForXBOX360(const FileName: String; const Width, Height: Integer; Mirror, ForceAlt: Boolean): Boolean; overload;
  end;
...
function TDR2Font.SaveForXBOX360(const Stream: TStream; const Width, Height: Integer; Mirror, ForceAlt: Boolean): Boolean;
var 
    FontHeader: TFontHeader;
    TexHeader:  TTexHeader;
    KerningHeader: TKerningHeader;
...
function TDR2Font.SaveForXBOX360(const FileName: String; const Width, Height: Integer; Mirror, ForceAlt: Boolean): Boolean;
var Stream: TMemoryStream;
begin
  Stream := TMemoryStream.Create;
