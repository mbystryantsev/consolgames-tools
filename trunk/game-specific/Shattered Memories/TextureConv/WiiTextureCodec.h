...
public:
	...
	virtual uint32 encodedRasterSize(int format, int width, int height, int mipmaps) const override;
	...
	virtual bool encode(void* result, const void* image, int format, int width, int height, void* palette, int paletteFormat, int mipmaps) override;
